...
<%
    ...
    int idCurso = 2; // ID real del curso principiante
...
<html lang="es">
    ...
    <body>
                ...
                <div class="menu-container">
                    ...
                    <div class="menu-lateral">
                        ...
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-1')">
                            2.1. Sistemas Operativos: Conceptos básicos, diferencias entre Windows, macOS y Linux
                            <span class="chev">▸</span>
                        </button>
                        <div id="sub-1-1" class="submenu">
                            <button onclick="cargarContenido('2.1.doc')">Documento</button>
                            <button onclick="cargarContenido('2.1.actividad')">Actividad</button>
                        </div>

                        <!-- 1.2 -->
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-2')">
                            2.2. Navegadores Web: Explorar internet, uso de buscadores y marcadores
                            <span class="chev">▸</span>
                        </button>
                        <div id="sub-1-2" class="submenu">
                            <button onclick="cargarContenido('2.2.doc')">Documento</button>
                            <button onclick="cargarContenido('2.2.actividad')">Actividad</button>
                        </div>

                        <!-- 1.3 -->
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-3')">
                            2.3. Correo Eléctronico: Crear una cuenta, enviar y recibir correos
                            <span class="chev">▸</span>
                        </button>
                        ...
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-4')">
                            2.4. Procesador de Textos (Microsoft Word): Formato de texto, tablas, imagenes e impresion
                            <span class="chev">▸</span>
                        </button>
                        ...
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-5')">
                            2.5. Hojas de Calculo(Microsoft Excel): Crear tablas, formulas básicas y gráficos
                            <span class="chev">▸</span>
                        </button>
                        ...
                        <button class="menu-btn" onclick="toggleSubmenu('sub-1-6')">
                            2.6. Presentaciones (Microsoft PowerPoint): Crear diapositivaS, animaciones y efectos visuales
                            <span class="chev">▸</span>
                        </button>
                        ...
                        <form action="SvIniciarEvaluacion" method="GET">
                            ...
                            <input type="hidden" name="vista" value="avanzado">
                    ...
                    <div class="contenido-principal">
                        ...
                        <div id="contenidoProgreso" class="seccion">
                            <!-- AÑADIDO: elementos que el script actualiza (existían en versiones previas) -->
        ...
        <script>
            ...
            // Grafica: actividades + evaluación final (último elemento)
