<%-- listaActividadesInstructor.jsp --%>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td><%= a.getTipo() %></td>
                <td>
                    <button class="editar" onclick="abrirEditar('<%= a.getIdActividad() %>', '<%= a.getTitulo() %>', '<%= a.getDescripcion() %>', '<%= a.getTipo() %>')">Editar</button>
            ...
            <div class="modal_registro" id="modalRegistro">
                <div class="modal_content_formulario">
                    ...
                    <form action="SvCrearActividad" method="POST" accept-charset="UTF-8">
                        ...
                        <textarea name="descripcion" placeholder="Descripción" style="width: 85%" required></textarea>
